...
class TrainerEnv():
    ...
    def reset(self):
        wait_until(self.on_home_tab, timeout=120, period=0.05)
        self.start_trainer()
        wait_until(self.in_game, timeout=-1, period=0.05)
    ...
    def start_trainer(self) -> None:
        self._interface.tap(980, 300)
        time.sleep(0.5)
        self._interface.tap(637, 714)
        time.sleep(0.5)
        self._interface.tap(736, 1368)
    ...
    def on_home_tab(self) -> bool:
        """
        Checks for on clan tab via red x and clan background
        """

        return self.check_pixels([[533, 2222], [995, 292], [551, 2281]], [[239, 227, 213], [255, 255, 246], [149, 116, 85]])
    ...
    def in_game(self) -> bool:
        ...
        return self.check_pixels([[106, 2053], [246, 2309], [1041, 2256]], [[252, 251, 253], [189, 26, 192], [160, 84, 11]])
    ...
    def terminal(self) -> bool:
        ...
        return self.check_pixels([[106, 2053]], [[252, 251, 253]]) != self.check_pixels([[246, 2309], [1041, 2256]], [[189, 26, 192], [160, 84, 11]])
...
if __name__ == "__main__":
    ...
    env = TrainerEnv(serial="RFCWC04A2VY")
    #env.reset()
    ...
    print("On Clan Tab:", env.on_home_tab())
